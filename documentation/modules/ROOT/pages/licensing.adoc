...
All software in OPS4J is licensed by the author to everyone under the https://www.apache.org/licenses/LICENSE-2.0.txt[Apache License, Version 2.0].

* Text version: https://www.apache.org/licenses/LICENSE-2.0.txt
* SPDX short identifier: https://spdx.org/licenses/Apache-2.0.html[Apache-2.0]
